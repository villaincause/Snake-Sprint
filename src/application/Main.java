...
public class Main extends Application {
	...
	private static final String[] FOODS_IMAGE = new String[] {"/img/ic_orange.png", "/img/ic_apple.png", "/img/ic_cherry.png",
			"/img/ic_berry.png", "/img/ic_coconut.png", "/img/ic_peach.png", "/img/ic_watermelon.png", "/img/ic_pomegranate.png"};
	...
	public void start(Stage primaryStage) throws Exception {
		primaryStage.setTitle("SnakeSprint");
	...
	private void generateFood() {
		start:
			while (true) {
				...
				foodImage = new Image(getClass().getResourceAsStream(FOODS_IMAGE[(int) (Math.random() * FOODS_IMAGE.length)]));
				break;
			}
	}
